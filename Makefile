...
# translation
SOURCES = bufferbypercentage.py ui_bufferbypercentage.py __init__.py bufferbypercentagedialog.py
#TRANSLATIONS = i18n/bufferbypercentage_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = bufferbypercentage

PY_FILES = bufferbypercentage.py bufferbypercentagedialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_bufferbypercentage.py
